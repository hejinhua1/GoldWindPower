...
class MLP(torch.nn.Module):
    ...
    def __init__(self, input_size, output_horizon, obs_len):
        super(MLP, self).__init__()

        self.linear1 = torch.nn.Linear(input_size*obs_len, 48)
        self.linear2 = torch.nn.Linear(48, 48)
        self.linear3 = torch.nn.Linear(48, output_horizon)
